 ...
 */
export async function getPaginatedPostsByUserIdTagIdsPageNum({userId, tagIds, pageNum}: { userId: number, tagIds: number[], pageNum: number }): Promise<PaginatedPostsWithCount | null> {
