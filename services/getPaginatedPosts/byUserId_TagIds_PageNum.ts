 ...
 * @param {number} tagIds - directoryId의 posts 탐색
 * @param {number} pageNum - 탐색한 posts skip & limit
 */
export async function getPaginatedPostsByUserIdTagIdsPageNum({userId, tagIds, pageNum}: { userId: number, tagIds: number[], pageNum: number }): Promise<GetPaginatedPostDocument | null> {
