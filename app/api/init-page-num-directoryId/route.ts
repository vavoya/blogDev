...
import { getInitPageNumByUserIdSlugDirectoryId } from "@/services/getInitPageNum/byUserId_Slug_DirectoryId";
...
export async function GET(request: NextRequest) {
    ...
    // db쿼리 시작
    try {
        const paginatedPosts: GetInitPageNum | null = await getInitPageNumByUserIdSlugDirectoryId({ userId, slug });
